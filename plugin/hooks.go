...
const (
	...
	ReactionHasBeenAddedId   = 17
	ReactionHasBeenRemovedId = 18
	TotalHooksId             = iota
)
...
type Hooks interface {
	...
	// ReactionHasBeenAdded is invoked after a user has posted a reaction to a message
	ReactionHasBeenAdded(c *Context, post *model.Post, reaction *model.Reaction)

	// ReactionHasBeenRemoved is invoked after a user has removed a reaction from a message
